...
urlpatterns = [
    ...
    url(r"^urn/delete/(?P<pk>[0-9]+)$", views.UrnDelete.as_view(), name="urn_delete"),
    # GraveGood
    url(
    ...
    url(
        r"^book-autocomplete/$",
        dal_views.BookAC.as_view(model=Book),
        name="book-autocomplete",
    ),
    url(
        r"^burialsite-autocomplete/$",
        dal_views.BurialSiteAC.as_view(model=BurialSite),
        name="burialsite-autocomplete",
    ),
    url(
        r"^burialgroup-autocomplete/$",
        dal_views.BurialGroupAC.as_view(model=BurialGroup),
        name="burialgroup-autocomplete",
    ),
    url(
        r"^burial-autocomplete/$",
        dal_views.BurialAC.as_view(model=Burial),
        name="burial-autocomplete",
    ),
    url(
        r"^urncover-autocomplete/$",
        dal_views.UrnCoverAC.as_view(model=UrnCover),
